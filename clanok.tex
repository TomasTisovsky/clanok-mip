...
Stredná časť diagramu sa zaoberá dátovej stránke projektu. V tejto fáze sa vývojári venujú dátam a operáciam s nimi. Vzniká tu multidimenzionálny model, ktorý je podstatou DW/BI projekov. Taktiež sa tu tvorí fyzický model a prebehne ETL proces(extract, transform, load). 
Spodná časť diagramu sa sustredí na výstupy pre uživateľov vo forme multidimenzionalnej aplikácie. 
V sekcií s názvom rast sú vyjadrené praktiky inkrementálnosti. Táto sekcia  hovorí o tom , že pri každom prírastku dát by sa vývojári mali vracať k plánu a držať sa požiadaviek uživateľov. Nasledujúca časť článku je venovaná jednotlivím etapám životného cyklu. \cite{Kimball2013}
...
Zároveň je výhodné ak sa na stretnutiach so zákaznkmi zúčastnujú aj dátoví analytici, ktorý do hĺbky rozumrjú uživateľským dátam a môžu prispieť k správnemu smerovaniu zberu požiadaviek. 
...
V tejto fáze sa nainštaluje dátový sklad, predstaví sa jeho budúcim užívatelom, začne sa používať a zároveň sa začne riadiť jeho rast a údržba. Nasadenie zahŕňa všetky časti potrebné na poskytnutie prístupu užívateľom k informáciám vo forme, ktorá im vyhovuje. Časť z tohto procesu začína na začiatku životného cyklu, v čase, keď sa vytvára architektúra a buduje sa dátový sklad, musí sa vytvárať dokumentácia, pripravovať školenia a organizovať procesy podpory. Školenia pomáhajú budúcim užívatelom osvojiť si vytvorený produkt a orientovať sa v aplikáciach a výstupoch. Všetky tieto prevádzkové služby musia byť zavedené ešte pred inštaláciou. Pri technických úlohách testovania a nasadzovania systému ide o proces presunu kódu z vývojového prostredia do testovacieho systému, kde sa otestuje funkčnosť a výkon a potom sa nasadí systém do prevádzky. Aj po nasadení je potreba vynakladať zdroje na užívateľskú či technickú podporu. Je dôležité mať funkčnosť a výkon dátového skladu neustále pod kontorlou, preto treba monitorovacie procesy, ktoré vedia včas odhaliť chyby v dátovej kvalite. Taktiež je potrebné včas oznámiť užívateľom nájdené chyby a dohodnúť sa na prípadných zmenách. Pri vývoji by sa malo počítať s tým, že dátový sklad má tendenciu rásť v objeme dát, v počte užívateľov a v počte aplikácií. Z toho dôvodu je nutné zahrnúť praktiky inkrementálnosti, a pri každom prírastku dát by sa vývojári mali vracať k plánu a držať sa požiadaviek uživateľov.\cite{Datamodeling}\cite{Kimball2013}\cite{Lacko2003}

\section{Zhrnutie} \label{zaver} % prípadne iný variant názvu

Cieľom tohto článku bolo stručne popísať kompletný životný cyklus dátových skladov. Článok daný cieľ splnil  vrámci stanoveného rozsahu. Článok slúži ako oboznámenie sa s danou problematikou a stručne predstavuje jednotlivé praktiky a postupy pri vytváraní dátových skladov a BI aplikácií. Kapitoly boli určené jednotlivím etapám životného cyklu v poradí v akom majú pri budovaní dátového skladu nasledovať. Táto téma je však veľmi komplexná a ponúka mnoho možností na ďalšie rozpracovanie. Napríklad v kapitole o technologickej fáze projektu by sa mohla hlbšie venovať konkrétnym postupom budovania architektúry alebo konkrétnym softvérovým nástrojom na budovanie dátového skladu. Ďalšia možnosť na rozšírenie práce spočíva v hlbšom rozpracovaní aplikačnej fázy projektu, konkrétne analytických aplikácií. Z článku vyplíva, že pri vytvorení plánu, dodržiavaní tohto plánu a taktiež pri zavedení agilných praktík dochádza k výraznému skráterniu doby vývoja daného projektu a taktiež k efektívnejšiemu využívaniu zdrojov.  
